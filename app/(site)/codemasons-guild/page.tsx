...
export default function CodemasonsGuildPage() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
          ...
          <div className="flex items-center justify-center z-10 px-8 lg:px-16 pt-14">
            <div className="w-full text-center">
              <div className="mb-10 mx-auto" style={{ maxWidth: "350px" }}>
                <Image 
                  src="/images/codemasons-guild-1.png" 
                  alt="Codemasons Guild Logo" 
                  width={441} 
                  height={229}
                  priority
              ...
              <h2 className="text-[#D2F381] text-2xl mb-2 tracking-wider font-medium">THE CODEMASONS GUILD</h2>
              
              <p className="text-white text-2xl mb-8 font-light">
                Designing and engineering dreams into reality.
              </p>
              
              <h1 className="text-white text-7xl md:text-9xl font-black mb-12 tracking-tight leading-none">COMING SOON</h1>
              
              <Link 
                href="https://dltcafe.com/codemasons-apply" 
                target="_blank"
              ...
              <p className="text-[#D2F381] text-sm mt-4 hover:underline cursor-pointer">
                <Link href="https://dltcafe.com/codemasons-invite">Already have an invite?</Link>
              </p>
            </div>
          </div>
          ...
          <div className="relative h-[50vh] lg:h-screen lg:min-h-[100svh] w-full order-first lg:order-last">
            <Image
              src="/images/codemasons.jpg"
              alt="Codemasons Guild"
              fill
              priority
